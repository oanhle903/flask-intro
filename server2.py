    ...
    <html>
      ...
      <body>
        ...
        <form action="/process-hello">
          Would you rather ne complimented or insulted?
          <input type="radio" name="niceormean" value="nice">A compliment, please!
          <input type="radio" name="niceormean" value="mean">I'll take an insult.
          <input type="submit">
        </form>
      </body>
    </html>
        ...
        <html>
          ...
          <body>
            ...
            <form action="/select-compliment">
              <select name="level">
                <option value="1">Just say somthing nice.</option>
...
def display_compliment_form():
    ...
    if level == 1:
        option_elements = [
            option_template.format(comp=comp) for comp in AWESOMENESS[0:3]
        ]
    elif level == 2:
        option_elements = [
